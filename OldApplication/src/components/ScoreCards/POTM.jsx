        ...
        <div className="p-4 font-SairaCondensed w-full flex max-md:flex-col-reverse  flex-grow space-x-10">
            ...
            <div>
                <div
                    ...
                    className={`p-8 relative ${strifs && 'strifs'} text-white w-80 h-80 flex flex-col items-center justify-center rounded-lg shadow-lg`}
                >
                    <p
                    ...
                    <div className={`absolute bottom-3 z-10 w-full ${strifs && 'bg-[#360607] rounded-lg'}`}>
                        <h1
    ...
    return (
        <>
            ...
            <div className={`grid grid-cols-2 text-sm font-bold w-[70%] mx-auto  scale-90 `} style={{ color: colors.textColor }}>
                {/* Score */}
                <div className="flex p-2 justify-between mx-auto w-full  z-10 border-r border-b" style={{ borderColor: colors.borderColor }}>
                    <p className="overflow-hidden" style={{ color: colors.labelColor }}>Score:</p>
                    <p>{playerData.score || "0"}</p>
                </div>

                {/* Balls Faced */}
                <div className="flex p-2 justify-between mx-auto w-full z-10 border-b" style={{ borderColor: colors.borderColor }}>
                ...
                {/* Strike Rate */}
                <div className="flex p-2 justify-between mx-auto w-full z-10 border-r" style={{ borderColor: colors.borderColor }}>
    ...
    return (
        <>
            <div className={`grid grid-cols-2 text-sm font-bold w-[70%] mx-auto scale-95 mb-3`} style={{ color: colors.textColor }}>
                ...
                {/* Strike Rate */}
                <div className="flex p-2 justify-between mx-auto w-full z-10 " style={{ borderColor: colors.borderColor }}>
        ...
        <>
            ...
            <div className="flex">
                <div className={`grid grid-cols-2 text-xs font-semibold w-[60%] mx-auto scale-90 mb-2`} style={{ color: colors.textColor }}>
                    <div className="flex py-0.25 px-2 justify-between mx-auto w-full z-10 border-r border-b" style={{ borderColor: colors.borderColor }}>
                        <p className="overflow-hidden" style={{ color: colors.labelColor }}>Overs:</p>
                        <p>{AllrounderData.overs}</p>
                    </div>

                    {/* Wickets */}
                    <div className="flex py-0.25 px-2 justify-between mx-auto w-full z-10 border-b" style={{ borderColor: colors.borderColor }}>
                        <p className="overflow-hidden" style={{ color: colors.labelColor }}>Wickets:</p>
                        <p>{AllrounderData.wickets}</p>
                    </div>

                    {/* Runs Conceded */}
                    <div className="flex py-0.25 px-2 justify-between mx-auto w-full z-10 border-r" style={{ borderColor: colors.borderColor }}>
                        <p className="overflow-hidden" style={{ color: colors.labelColor }}>Runs:</p>
                        <p>{AllrounderData.runs}</p>
                    </div>

                    {/* Strike Rate */}
                    <div className="flex py-0.25 px-2 justify-between mx-auto w-full z-10" style={{ borderColor: colors.borderColor }}>
                        <p className="overflow-hidden" style={{ color: colors.labelColor }}>Econ:</p>
