    ...
    return (
        <div className="p-4 font-SairaCondensed w-full flex flex-grow space-x-10">
            ...
            <div>
                <div
                    ref={divRef}
                    className="p-8 relative bg-[#96bcda] text-white w-64 h-72 flex flex-col items-center justify-center rounded-lg shadow-lg"
                >
                    <p className="text-[#360607] leading-tight tracking-[0.2em] uppercase text-[15px] font-bold absolute top-2 shadow-2xl">Sheikh Jana Champions</p>
                    {playerData.image && (
                        <img
                    ...
                    <div className="absolute  top-10  left-1.5  z-0 flex space-x-1">
                        ...
                        <p className=" flex flex-col text-left text-[#360607] leading-tight uppercase text-[6px] font-bold">
                    ...
                    <div className="absolute bottom-0 z-10 w-full">
                        <h1 className="text-base mx-auto w-fit z-10 bg-[#360607] leading-tight tracking-[0.2em] uppercase text-[15px] font-bold px-4 py-1 rounded-xl">
                            {playerData.name || "Player Name"}
                        </h1>
                        <div className="grid grid-cols-2 text-sm font-bold w-[70%] mx-auto h-14 scale-95 text-[#360607]">
                            {/* Score */}
