...
const POTM = () => {
  ...
  const renderComponent = () => {
    if (selectedAward.includes("Batsman"))
      return <Batsmancomponent colors={colors} playerData={playerData} />;
    if (selectedAward.includes("Bowler"))
      return <BowlerComponent colors={colors} bowlerData={bowlerData} />;
    if (selectedAward.includes("Allrounder"))
      return (
        <AllrounderComponent
          colors={colors}
          AllrounderData={bowlerData}
    ...
    <div className="p-4 font-SairaCondensed w-full flex max-md:flex-col-reverse  flex-grow space-x-10">
      <div className="mb-4 grid grid-cols-2 gap-2 max-md:grid-cols-1 max-md:mt-3">
        <select
          ...
          className="block w-full mb-2 p-2 border border-gray-300 uppercase rounded"
        >
          <option value="">Select Award</option>
          <option value="Player of the Match (Batsman)">
            Player of the Match (Batsman)
          </option>
          <option value="Player of the Match (Bowler)">
            Player of the Match (Bowler)
          </option>
          <option value="Player of the Match (Allrounder)">
            Player of the Match (AllRounder)
          </option>
          <option value="Best Bowler of the Match">
            Best Bowler of the Match
          </option>
          <option value="Best Batsman of the Match">
        ...
        <input
          ...
          onChange={(e) =>
            setBowlerData({ ...bowlerData, overs: e.target.value })
          }
          className="block w-full mb-2 p-2 border border-gray-300 rounded"
        />
        ...
        <input
          ...
          onChange={(e) =>
            setBowlerData({ ...bowlerData, wickets: e.target.value })
          }
          className="block w-full mb-2 p-2 border border-gray-300 rounded"
        />
        ...
        <input
          ...
          onChange={(e) =>
            setBowlerData({ ...bowlerData, runs: e.target.value })
          }
          className="block w-full mb-2 p-2 border border-gray-300 rounded"
        />
        ...
        <div className="flex flex-col mb-2">
          <button
            className="mt-4 bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 w-fit"
            onClick={() => {
              setStrifs(!strifs);
            }}
          >
      ...
      <div>
        <div
          ...
          className={`p-8 relative ${
            strifs && "strifs"
          } text-white w-80 h-80 flex flex-col items-center justify-center rounded-lg shadow-lg`}
        >
          <img
            src={triangle22}
            className=" w-96 opacity-15 aspect-square  z-10"
            alt=""
          />
          ...
          <p
            ...
            className={`leading-tight tracking-[0.2em] uppercase text-[15px] font-bold absolute top-2 shadow-2xl ${
              strifs && "bg-[#360607] rounded-lg p-1.5"
            }`}
          >
          ...
          <img
            src={flame}
            className="absolute w-52 scale-[0.8] opacity-70 aspect-square top-0 -right-4 z-10"
            alt=""
          />
          <img
            src={triangle}
            className="absolute scale-[0.8] w-40 aspect-square top-10 right-3 rotate-12 z-0"
            alt=""
          />
          <div className="absolute top-10 left-1.5 z-0 flex space-x-1">
            <img src={spl2} className="w-4 aspect-square" alt="" />
            <p
              className={`flex flex-col text-left leading-tight uppercase text-[6px] font-bold ${
                strifs && "bg-[#360607] rounded-lg p-1.5"
              }`}
              style={{ color: colors.textColor }}
            >
              ...
              <span className="text-[#fc065e] tracking-[0.2em]">
                2nd edition 2024
              </span>
            </p>
          </div>
          ...
          <div
            className={`absolute bottom-3 z-10 w-full ${
              strifs && "bg-[#360607] rounded-lg"
            }`}
          >
            <h1
...
function Batsmancomponent({ colors, playerData }) {
  return (
    <>
      <div
        className={`grid grid-cols-2 text-sm font-bold w-[70%] mx-auto  scale-90 `}
        style={{ color: colors.textColor }}
      >
        {/* Score */}
        <div
          className="flex p-2 justify-between mx-auto w-full  z-10 border-r border-b"
          style={{ borderColor: colors.borderColor }}
        >
          <p className="overflow-hidden" style={{ color: colors.labelColor }}>
            Score:
          </p>
        ...
        {/* Balls Faced */}
        <div
          className="flex p-2 justify-between mx-auto w-full z-10 border-b"
          style={{ borderColor: colors.borderColor }}
        >
          <p className="overflow-hidden" style={{ color: colors.labelColor }}>
            Balls Faced:
        ...
        {/* Strike Rate */}
        <div
          className="flex p-2 justify-between mx-auto w-full z-10 border-r"
          style={{ borderColor: colors.borderColor }}
        >
          <p className="overflow-hidden" style={{ color: colors.labelColor }}>
            SR:
...
function BowlerComponent({ colors, bowlerData }) {
  ...
  const totalBalls =
    Math.floor(bowlerData.overs) * 6 + (bowlerData.overs % 1) * 10;

  return (
    <>
      <div
        className={`grid grid-cols-2 text-sm font-bold w-[70%] mx-auto scale-95 mb-3`}
        style={{ color: colors.textColor }}
      >
        {/* Overs */}
        <div
        ...
        {/* Strike Rate */}
        <div
          className="flex p-2 justify-between mx-auto w-full z-10 "
          style={{ borderColor: colors.borderColor }}
        >
          <p className="overflow-hidden" style={{ color: colors.labelColor }}>
            Econ:
          ...
          <p>
            {Math.ceil((bowlerData.runs / bowlerData.overs) * 10000) / 10000}
          </p>
        </div>
      </div>
    </>
...
function AllrounderComponent({ colors, AllrounderData, playerData }) {
  return (
    <>
      ...
      <div className="flex">
        <div
          className={`grid grid-cols-2 text-xs font-semibold w-[60%] mx-auto scale-90 mb-2`}
          style={{ color: colors.textColor }}
        >
          <div
            className="flex py-0.25 px-2 justify-between mx-auto w-full z-10 border-r border-b"
            style={{ borderColor: colors.borderColor }}
          >
            <p className="overflow-hidden" style={{ color: colors.labelColor }}>
              Overs:
          ...
          {/* Wickets */}
          <div
            className="flex py-0.25 px-2 justify-between mx-auto w-full z-10 border-b"
            style={{ borderColor: colors.borderColor }}
          >
            <p className="overflow-hidden" style={{ color: colors.labelColor }}>
              Wickets:
          ...
          {/* Runs Conceded */}
          <div
            className="flex py-0.25 px-2 justify-between mx-auto w-full z-10 border-r"
            style={{ borderColor: colors.borderColor }}
          >
            <p className="overflow-hidden" style={{ color: colors.labelColor }}>
              Runs:
          ...
          {/* Strike Rate */}
          <div
            className="flex py-0.25 px-2 justify-between mx-auto w-full z-10"
            style={{ borderColor: colors.borderColor }}
          >
            <p className="overflow-hidden" style={{ color: colors.labelColor }}>
              Econ:
            ...
            <p>
              {Math.ceil((AllrounderData.runs / AllrounderData.overs) * 10000) /
                10000}
            </p>
          </div>
        </div>
        ...
        <div
          className={`grid grid-cols-2 text-xs font-semibold w-[60%] mx-auto scale-90`}
          style={{ color: colors.textColor }}
        >
          <div
            className="flex py-0.25 px-2 justify-between mx-auto w-full z-10 border-r border-b"
